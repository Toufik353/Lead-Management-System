...
const CallbackScheduler = () => {
  ...
  const fetchCallbacks = async () => {
    try {
      const response = await axios.get(`https://lead-management-system-restapi.onrender.com/api/callbacks`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://lead-management-system-restapi.onrender.com/api/callbacks`, formData);
      setShow(false);
      fetchCallbacks();
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://lead-management-system-restapi.onrender.com/api/callbacks/${id}`);
      fetchCallbacks();
    } catch (error) {
